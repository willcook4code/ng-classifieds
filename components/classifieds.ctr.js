		...
		.controller("classfiedsCtrl", function($scope) {
			$scope.classifieds = [
				...
				},
				{
					"id":"4",
					"title":"Bulldog Puppy",
					"description":"100% pure breed. Papered. Microchipped. Shots up to date. 1 yr health guarantee. Perfect Temperament to live with kids or other dogs. Beautiful and super sweet English Bulldog Puppy for sale ready to find a new home. Profesional and knowledgeable English Bulldog Breeder.",
					"price":250,
					"posted":"2015-11-01",
					"contact": {
					  "name":"John Doe",
					...
					"image":"http://images2.backpage.com/imager/u/large/296732838/dcbd3cfb37d747c6d300b3e8e3c36db8.jpg",
					"views":77
				},
				{
					"id":"5",
